...
namespace QuantityMeasurementApp.Domain
{
    ...
    public class QuantityLength
    {
        ...
        public QuantityLength Add(QuantityLength other)
        {
            ...
            double sumInBase = unit.ConvertToBaseUnit(value) + other.unit.ConvertToBaseUnit(other.value);
        ...
        private static QuantityLength AddInternal(QuantityLength length1, QuantityLength length2, LengthUnit targetUnit)
        {
            ...
            double sumInBase = length1.unit.ConvertToBaseUnit(length1.value)
                + length2.unit.ConvertToBaseUnit(length2.value);
